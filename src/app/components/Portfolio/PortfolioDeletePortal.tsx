    ...
    <div className="fixed inset-0 z-50">
      <div className="h-screen w-screen absolute top-0 left-0 bg-[rgba(43,38,86,0.7)] overflow-y-hidden">
        <div className="relative h-screen w-screen overflow-y-hidden">
          <div className="w-[85%] lg:w-[40%] h-1/2 py-10 px-12 z-50 rounded-xl inset-0 dark:bg-[#13121A] bg-white absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] transform ">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex justify-center items-center w-full h-36 sm:h-44 lg:h-60">
              ...
              <div className="flex justify-center items-center gap-4">
                <motion.button
                  ...
                  className="bg-[#B0B0EC] dark:bg-[#3A3A78] px-10 lg:px-20 py-2 rounded-xl text-white"
                  onClick={() => {
