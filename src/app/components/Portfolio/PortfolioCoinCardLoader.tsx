  ...
  return (
    <div className="flex gap-8 flex-col my-8">
      <div className="h-80 w-full flex flex-col lg:flex-row">
        <div className="dark:bg-[#1E1932] bg-white w-full lg:w-[20%] h-full flex justify-center items-center flex-col p-12 lg:p-0">
        ...
        <div className="dark:bg-[#191932] bg-[#EBEBFC] w-full lg:w-[80%] h-full flex flex-col">
          <div className="h-1/2 w-full mt-6">
            ...
            <div className="flex items-center mt-8 w-full ">
              <div className="w-2/4 sm:w-1/4 text-center">
              ...
              <div className="w-1/4 text-center hidden sm:block">
          ...
          <div className="h-1/2 w-full mt-6">
            <div className="w-full flex justify-between text-center">
              <div className="text-center ml-4 hidden sm:block">
